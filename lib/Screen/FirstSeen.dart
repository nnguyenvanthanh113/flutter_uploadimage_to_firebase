...
import 'package:flutter_uploadimage_to_firebase/Contants/contants.dart';
          ...
          child: ListView(
            children: <Widget>[
              ...
              Padding(
                ...
                child: RichText(
                  text: const TextSpan(
                      text: "Đây là khóa bí mật, vui lòng ghi nhớ!",
                      children: [
                        TextSpan(
                            text: "",
                            style: TextStyle(
              ...
              Padding(
                ...
                child: Text(
                  hasError ? "*Hãy điền đầy đủ mật khẩu" : "",
                  ...
                  child: TextButton(
                    onPressed: () async {
                      ...
                      if (currentText.length != 6) {
                        ...
                        preferences.setInt('calculatorPass', password);
